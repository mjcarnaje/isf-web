...
VALUES
    ...
    ('Meow Mixer', 'Calling all cat enthusiasts! Join us for the Meow Mixer, a social gathering for cat lovers. Enjoy cat-themed activities, treats, and meet adorable feline friends.', 'isf/default-event', '2023-05-10 12:00:00', '2023-05-10 17:00:00', 'Cat Cafe', @admin_user_id, 0, "Public", "Anyone"),
    ('Paws in the Park', 'Bring your furry friends to Paws in the Park, a community event filled with pet-friendly activities, live music, and a chance to connect with fellow pet owners.', 'isf/default-event', '2023-06-20 14:00:00', '2023-06-20 19:00:00', 'City Park', @admin_user_id, 0, "Public", "Anyone"),
    ('Senior Pets Day', 'Celebrate the wisdom and charm of senior pets at our Senior Pets Day. Meet older dogs and cats looking for a peaceful and loving retirement home.', 'isf/default-event', '2023-07-15 16:00:00', '2023-07-15 21:00:00', 'Senior Pet Sanctuary', @admin_user_id, 0, "Public", "Anyone"),
    ('Kitten Carnival', 'Experience the cuteness overload at the Kitten Carnival! Play with adorable kittens, enjoy carnival games, and learn about responsible kitten care.', 'isf/default-event', '2023-08-10 18:00:00', '2023-08-10 23:00:00', 'Community Center', @admin_user_id, 0, "Public", "Anyone"),
    ('Doggy Dash', 'Get ready for the Doggy Dash, a fun run for dogs and their owners! Join us for a day of fitness, prizes, and a tail-wagging good time.', 'isf/default-event', '2023-09-20 20:00:00', '2023-09-20 01:00:00', 'Dog Park', @admin_user_id, 0, "Verified User", "Interested"),
    ('Purrfect Picnic', 'Enjoy a Purrfect Picnic with cats! Bring your feline friends, indulge in tasty treats, and relax in a cat-friendly outdoor setting.', 'isf/default-event', '2023-10-15 22:00:00', '2023-10-16 03:00:00', 'Cat Garden', @admin_user_id, 0, "Public", "Anyone");
