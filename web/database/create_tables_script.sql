...
VALUES
    ('Buddy', 'Dog', 'March', '2019', 'isf/default-dog', 'Male', 0, 0, 1, 1, 1, 0, 'Buddy is a gentle and friendly dog who loves belly rubs. He has a brown and white coat and is of medium size.', 'Brown and white fur, medium size', @admin_user_id),
    ('Whiskers', 'Cat', 'July', '2020', 'isf/default-cat', 'Female', 1, 0, 1, 0, 1, 0, 'Whiskers is a playful and curious cat with striking black and white fur. She enjoys playing with toys and cuddling.', 'Black and white fur, small size', @admin_user_id),
    ('Maximus', 'Dog', 'January', '2018', 'isf/default-dog', 'Male', 0, 1, 1, 1, 1, 0, 'Maximus is a loyal and protective dog. He has a sleek black coat and is of large size, making him an excellent companion for walks.', 'Black fur, large size', @admin_user_id),
    ('Mittens', 'Cat', 'April', '2019', 'isf/default-cat', 'Male', 0, 0, 1, 1, 1, 0, 'Mittens is a charming and laid-back cat. He has a fluffy gray and white coat, making him an ideal cuddle buddy.', 'Gray and white fur, medium size', @admin_user_id),
    ('Lola', 'Dog', 'September', '2020', 'isf/default-dog', 'Female', 1, 0, 1, 0, 1, 0, 'Lola is an energetic and friendly dog who loves outdoor adventures. She has a beautiful golden coat and is of medium size.', 'Golden fur, medium size', @admin_user_id),
    ('Simba', 'Cat', 'June', '2022', 'isf/default-cat', 'Male', 0, 0, 1, 1, 1, 0, 'Simba is a playful and curious kitten. With his orange tabby markings, he is sure to capture your heart with his adorable antics.', 'Orange tabby fur, small size', @admin_user_id),
    ('Sasha', 'Dog', 'December', '2017', 'isf/default-dog', 'Female', 0, 1, 1, 1, 1, 0, 'Sasha is a sweet and gentle senior dog. She has a mix of black and white fur and enjoys leisurely strolls and quiet moments.', 'Black and white fur, medium size', @admin_user_id),
    ('Oliver', 'Cat', 'August', '2018', 'isf/default-cat', 'Male', 1, 0, 1, 0, 1, 0, 'Oliver is a dignified and independent cat. With his sleek black coat, he exudes elegance and charm.', 'Black fur, medium size', @admin_user_id),
    ('Rosie', 'Dog', 'May', '2019', 'isf/default-dog', 'Female', 0, 0, 1, 1, 1, 0, 'Rosie is a loving and loyal dog with a fluffy white coat. She enjoys cuddling on the couch and going for leisurely walks.', 'White fur, small size', @admin_user_id),
    ('Leo', 'Cat', 'October', '2021', 'isf/default-cat', 'Male', 1, 0, 1, 0, 1, 0, 'Leo is a mischievous and playful cat with distinctive black and orange markings. His vibrant personality will bring joy to any home.', 'Black and orange fur, small size', @admin_user_id);
